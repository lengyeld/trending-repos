...
export const githubLanguages = {
  ...
  "SELinux Policy": {
    ...
    extensions: [".te"],
    filenames: ["file_contexts", "genfs_contexts", "initial_sids", "port_contexts", "security_classes"],
    ace_mode: "text",
  ...
  "SSH Config": {
    type: "data",
    group: "INI",
    filenames: ["ssh-config", "ssh_config", "sshconfig", "sshconfig.snip", "sshd-config", "sshd_config"],
    ace_mode: "text",
  ...
  Starlark: {
    ...
    color: "#76d275",
    extensions: [".bzl", ".star"],
    filenames: ["BUCK", "BUILD", "BUILD.bazel", "MODULE.bazel", "Tiltfile", "WORKSPACE", "WORKSPACE.bazel"],
    aliases: ["bazel", "bzl"],
  ...
  TOML: {
    ...
    color: "#9c4221",
    extensions: [".toml"],
    filenames: ["Cargo.lock", "Gopkg.lock", "Pipfile", "pdm.lock", "poetry.lock"],
...
export type GithubLanguageKey = keyof typeof githubLanguages;
